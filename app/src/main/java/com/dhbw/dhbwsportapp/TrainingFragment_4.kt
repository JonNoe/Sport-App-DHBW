...
class TrainingFragment_4 : Fragment(), OnItemClickListener {
    private lateinit var recyclerViewTrainingFragment: RecyclerView
    private lateinit var dataList: ArrayList<Training_4_DataClass>
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_training_4, container, false)
        ...
        val adapter = Training_4_AdapterClass(dataList, this)
    ...
    private fun getData(){
        for (i in imageList.indices){
            val dataClass = Training_4_DataClass(imageList[i], titleList[i])
            dataList.add(dataClass)
        }
        recyclerViewTrainingFragment.adapter = Training_4_AdapterClass(dataList, this)
    }
    ...
    private fun navigateToTrainingStartFragment(startIndex: Int) {
        val trainingStartFragment = TrainingFragment_4_start()
        val args = Bundle()
